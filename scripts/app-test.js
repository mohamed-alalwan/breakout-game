window.onload = () => {
    ...
    //good perks
    let perkBall = false;
    let perkDoubleScore = false;
    //bad perks
    let perkRotateLeft  = false;
    let perkRotateRight = false;
    let perkFastSpeed = false;

    function handlePerkBall(){
        perkBall = true;
        console.log('ball perk');
    }

    function handlePerkDoubleScore(){
        perkDoubleScore = true;
        console.log('double score perk');
    }

    function handlePerkRotateLeft(){
        perkRotateLeft = true;
        console.log('rotate left perk');
    }

    function handlePerkRotateRight(){
        perkRotateRight = true;
        console.log('rotate right perk');
    }

    function handlePerkFastSpeed(){
        perkFastSpeed = true;
        console.log('fast speed perk');
    }

    function handleRandomPerk(){
        const i  = Math.floor(Math.random() * 5);
        switch(i){
            case 1: 
                handlePerkBall();
            case 2:
                handlePerkDoubleScore();
            case 3:
                handlePerkRotateLeft();
            case 4:
                handlePerkRotateRight();
            case 5:
                handlePerkFastSpeed();
        }
    }
    ...
    function showRandomPerk(block){
        ...
        //hide within timer
        setTimeout(hideRandomPerk, hideSpeed, randomPerk);
    }

    //hide random perk and destroy it
    function hideRandomPerk(randomPerk){
        if(!randomPerks.includes(randomPerk)) return;
